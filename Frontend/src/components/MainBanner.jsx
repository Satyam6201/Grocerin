...
const MainBanner = () => {
  return (
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex flex-col item-center md:item-start justify-end
      ...
      <div className='flex item-center mt-6 font-medium'>
        ...
        <Link to = {"/product"} 
        className='group hideen md:flex item-center gap-2 px-9 py-3 cursor-pointer'>
        Explore deals
